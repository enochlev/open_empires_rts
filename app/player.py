...
quests = [
    {"id":1, "text": "Collect 5 diamonds", "reward": 500, "func": lambda player: player.player_stats['Resources']['diamond'] >= 5},
    {"id":2, "text": "Gather 50 hay", "reward": 250, "func": lambda player: player.player_stats['Resources']['hay'] >= 50},
    {"id":3, "text": "Amass 100 iron", "reward": 500, "func": lambda player: player.player_stats['Resources']['iron'] >= 100},
    {"id":4, "text": "Accumulate 25 gold", "reward": 500, "func": lambda player: player.player_stats['Resources']['gold'] >= 25},
    {"id":5, "text": "Stockpile 100 stone", "reward": 250, "func": lambda player: player.player_stats['Resources']['stone'] >= 100},
    {"id":6, "text": "Train 10 soldiers", "reward": 300, "func": lambda player: player.player_stats['Units']['count']['Soldier'] >= 10},
    {"id":7, "text": "Have 8 buildings", "reward": 400, "func": lambda player: sum(player.player_stats['Buildings']['levels'].values()) >= 8},
    {"id":8, "text": "Have 15 buildings", "reward": 800, "func": lambda player: sum(player.player_stats['Buildings']['levels'].values()) >= 15},
    {"id":9, "text": "Harvest 100 wood", "reward": 200, "func": lambda player: player.player_stats['Resources']['wood'] >= 100},
    {"id":10, "text": "Forge 2 boats", "reward": 600, "func": lambda player: player.player_stats['Units']['count']['Boat'] >= 2},
    {"id":11, "text": "Conscript 5 cavalry", "reward": 350, "func": lambda player: player.player_stats['Units']['count']['Calvary'] >= 5},
    {"id":12, "text": "Construct a grand church", "reward": 800, "func": lambda player: player.player_stats['Buildings']['levels']['Church'] >= 1},
]
